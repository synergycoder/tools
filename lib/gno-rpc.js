...
export const NETWORKS = {
  ...
  // Pearl (pearl-1) replaced Sapphire as gno.land's active testnet,
  // 2026-08-27 — added as a new key rather than repointing "testnet" at
  // it, since other pages on this site (e.g. Wallet Scanner, Name
  // Registry) still deliberately target Sapphire/other chains for their
  // own unrelated reasons and shouldn't silently switch chains out from
  // under themselves. gems-mint.html and the gallery (gems/index.html)
  // were migrated to target NETWORKS.pearl directly, following Gems'
  // own g17->g18 collection migration to Pearl. No rpcFallbackUrls yet
  // -- unlike sapphire-1's pool above (vetted after a real full-day
  // outage), Pearl hasn't had one yet to prompt sourcing community
  // nodes; add one here if that ever happens.
  pearl: {
