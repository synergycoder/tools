...
function injectStyle() {
  ...
  style.textContent = `
    ...
    .gt-menu-dropdown{position:absolute;top:calc(100% + 8px);left:0;min-width:200px;background:var(--panel);
    ...
    .gt-menu-dropdown a{display:block;padding:9px 12px;border-radius:8px;color:var(--muted);
