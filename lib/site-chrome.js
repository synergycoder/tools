...
// above and the Vanity Address warning overlay. Checked once at module load
// so it applies before the very first render, not just after a re-render.
const UNLOCK_STORAGE_KEY = "gnoTools:unlocked:v1";
if (new URLSearchParams(window.location.search).get("on") === "1") {
