  ...
  const chains = (json.chains || [])
    ...
    .map((c) => {
      ...
      return {
        ...
        // SLIP-44 coin type — 60 is Ethereum's, and Cosmos SDK chains that
        // register under it (Injective, Evmos, Kava, Cronos, Dymension,
        // Canto, etc.) are almost always the EVM-style ones using
        // eth_secp256k1 keys + Keccak256 addressing, not this ecosystem's
        // usual secp256k1 + RIPEMD160(SHA256(pubkey)) scheme — used by
        // address-converter.html to flag likely-incompatible target chains.
        slip44: c.slip44 ?? null,
        denom: c.denom,
        decimals: c.decimals,
