...
// default (name-registry.html targets sapphire-1, wallet-scanner.html's
// NETWORKS only knows topaz-1) — this is only for the shared header's
// "which chain is my wallet on" display + native-balance lookup, not for
// picking which chain a tool reads from.
export const CHAIN_INFO = {
  "topaz-1": { label: "Testnet (topaz-1)", short: "Testnet", rpcUrl: "https://rpc.topaz.testnets.gno.land" },
  "sapphire-1": { label: "Testnet (sapphire-1)", short: "Testnet", rpcUrl: "https://rpc.sapphire.testnets.gno.land" },
